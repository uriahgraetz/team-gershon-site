    ...
    <section id="contact" className="py-32 px-[5vw] bg-dark">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 max-w-[1200px] mx-auto items-start">
        ...
        <div ref={infoRef} className="reveal pt-4">
          ...
          {/* Social media — icon-only row. Each link hovers to its brand
              color and scales up slightly. aria-labels carry the translated
              accessible name in place of visible text. */}
          <div className="flex justify-center items-center gap-6 mt-4">
            <a
              ...
              className="inline-flex items-center justify-center w-12 h-12 text-muted no-underline transition-all duration-200 hover:text-[#E1306C] hover:scale-110 focus-visible:text-[#E1306C] focus-visible:outline-none"
            >
              <InstagramIcon />
            </a>
            <a
              ...
              className="inline-flex items-center justify-center w-12 h-12 text-muted no-underline transition-all duration-200 hover:text-[#FF0000] hover:scale-110 focus-visible:text-[#FF0000] focus-visible:outline-none"
            >
              <YouTubeIcon />
            </a>
            <a
              ...
              className="inline-flex items-center justify-center w-12 h-12 text-muted no-underline transition-all duration-200 hover:text-[#1877F2] hover:scale-110 focus-visible:text-[#1877F2] focus-visible:outline-none"
            >
              <FacebookIcon />
            </a>
          </div>
